...
export default async function Adjustments(){
    ...
    return(
        <div>
            ...
            <DataTable data={addAjustments} columns={columns} updateLink="http://localhost:3000/dashboard/inventory/adjustments/new" resourceName="adjustments/add"/>
            </div>
            <div className="my-4 p-8">
            <h2 className="p-2 text-xl font-semibold">Stock Transfer Adjustment</h2>
            <DataTable data={transferAjustments} columns={columns1} resourceName="adjustments/transfer"/>
            </div>
        </div>
    );
}